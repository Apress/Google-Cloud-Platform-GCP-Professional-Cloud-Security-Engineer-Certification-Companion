...
# KEY_VERSION = the version of the key you want to decrypt, e.g. 1
...
# PLAINTEXT_PATHFILE = the pathname to your plaintext file you want to decrypt, e.g. ./input/plaintext
# CIPHERTEXT_PATHFILE = the pathname to your ciphertext file resulting from the asymmetric decryption, e.g. ./output/ciphertext
